class ChartsController < ApplicationController
  ...
  def sync
    pp "inside"
      dwh = PG::Connection.new(host: 'codeboxx-postgresql.cq6zrczewpu2.us-east-1.rds.amazonaws.com', port: 5432, dbname: "Dana_Duquette", user: "codeboxx", password: "Codeboxx1!")
